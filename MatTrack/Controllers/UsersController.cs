...
namespace MatTrack.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,FirstName,LastName,Rank,WeightInLbs,HeightInInch,CurrentlyInjured,PhoneNumber,EmailAddress")] Users users)
        {
            if (id != users.UserId)
            {
                return NotFound();
